...
public class QuizForm extends javax.swing.JFrame {
    ...
    private void jButtonNextQuesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonNextQuesActionPerformed
        ...
        if(index == questions.length)
        {
            ...
            // Use a for loop to display the options in radio buttons
             for (int i = 0; i < options[index].length - 1; i++) {
                 // Assuming you have four options per question
                 if (i == 0) {
                     jRadioButton1_.setText(options[index][i]);
                 } else if (i == 1) {
                     jRadioButton2_.setText(options[index][i]);
                 } else if (i == 2) {
                     jRadioButton3_.setText(options[index][i]);
                 } else if (i == 3) {
                     jRadioButton4_.setText(options[index][i]);
                 }
             }
